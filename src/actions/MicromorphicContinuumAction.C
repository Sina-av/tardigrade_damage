...
void
MicromorphicContinuumAction::addInternalForceKernels(const std::string& internal_force_kernel_name)
{
...
void
MicromorphicContinuumAction::addInternalCoupleKernels(const std::string& internal_couple_kernel_name)
{
  for ( unsigned int i = 0; i < 3 ; ++i )
...
MicromorphicContinuumAction::addKernels()
{
  ...
  addInternalForceKernels( "InternalForce" );

  addInternalCoupleKernels( "InternalCouple" );
}
